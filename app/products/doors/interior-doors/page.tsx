...
export default function InteriorDoorsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/quote?category=doors" className="inline-flex rounded-md bg-brand-green px-4 py-2 text-sm font-semibold text-white hover:bg-brand-greenDark">Request an Interior Door Quote</Link>
